...
ensemble_learning <- function(X, y, model_functions, method = "average", test_size = 0.2) {

  # Define linear model functions
  linear_models <- list(linear_logistic_regression, random_forest_model)

  # Define non-linear model functions
  non_linear_models <- list(lasso_regression, ridge_regression, elastic_net_regression)
